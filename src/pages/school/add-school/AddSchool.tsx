...
import { Container, Row, Col,  Form as BootstrapForm, Button,Figure } from "react-bootstrap";
//redux
          ...
          <FormikForm className={styles.form_plan}>
            <Row className="mb-3">
              ...
              <Col sm={3}>
                ...
                <BootstrapForm.Label htmlFor="schoolLogo">School logo</BootstrapForm.Label>
              ...
              <Col sm={9}>
                <Row>
                  <Col sm={6}>
                    <BootstrapForm.Label htmlFor="schoolName">School Name</BootstrapForm.Label>
                    <BootstrapForm.Control
                      type="text"
                      id="schoolName"
                  ...
                  <Col sm={6}>
                    <BootstrapForm.Label htmlFor="schoolType">School Type</BootstrapForm.Label>
            ...
            <Row className="mt-3">
              <BootstrapForm.Label htmlFor="schoolAddress">Address</BootstrapForm.Label>
              <Col sm={4}>
                <BootstrapForm.Control
                  type="text"
